                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <?= $this->Html->link(__('View'), ['controller' => 'UserLogs', 'action' => 'view', $userLogs->user_id]) ?>
                                <?= $this->Html->link(__('Edit'), ['controller' => 'UserLogs', 'action' => 'edit', $userLogs->user_id]) ?>
                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'UserLogs', 'action' => 'delete', $userLogs->user_id], ['confirm' => __('Are you sure you want to delete # {0}?', $userLogs->user_id)]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
