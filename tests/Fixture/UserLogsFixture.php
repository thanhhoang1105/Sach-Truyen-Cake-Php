...
class UserLogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ip' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                'user_id' => 1,
                'ip' => 1,
                'created' => '2021-05-17 15:43:54',
                'modified' => '2021-05-17 15:43:54',
            ],
        ];
        parent::init();
    }
