...
class MenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 25, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2021-05-17 13:41:18',
                'modified' => '2021-05-17 13:41:18',
            ],
        ];
        parent::init();
    }
